...
import 'package:hvac_control/generated/protos/schedule.pb.dart' as $0;
...
abstract class ScheduleServiceBase extends $grpc.Service {
  ...
  ScheduleServiceBase() {
    $addMethod(
        $grpc.ServiceMethod<$0.GetScheduleRequest, $0.ListScheduleResponse>(
            ...
            false,
            false,
            $0.GetScheduleRequest.fromBuffer,
    ...
    $addMethod($grpc.ServiceMethod<$0.CreateScheduleRequest, $0.ScheduleEntry>(
        ...
        false,
        false,
        $0.CreateScheduleRequest.fromBuffer,
    ...
    $addMethod($grpc.ServiceMethod<$0.UpdateScheduleRequest, $0.ScheduleEntry>(
        ...
        false,
        false,
        $0.UpdateScheduleRequest.fromBuffer,
        ($0.ScheduleEntry value) => value.writeToBuffer(),),);
    $addMethod($grpc.ServiceMethod<$0.DeleteScheduleRequest, $1.Empty>(
        ...
        false,
        false,
        $0.DeleteScheduleRequest.fromBuffer,
  ...
  $async.Future<$0.ListScheduleResponse> getSchedule_Pre(
      ...
      $async.Future<$0.GetScheduleRequest> $request,) async => getSchedule($call, await $request);
  ...
  $async.Future<$0.ScheduleEntry> createScheduleEntry_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.CreateScheduleRequest> $request,) async => createScheduleEntry($call, await $request);
  ...
  $async.Future<$0.ScheduleEntry> updateScheduleEntry_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.UpdateScheduleRequest> $request,) async => updateScheduleEntry($call, await $request);
  ...
  $async.Future<$1.Empty> deleteScheduleEntry_Pre($grpc.ServiceCall $call,
      $async.Future<$0.DeleteScheduleRequest> $request,) async => deleteScheduleEntry($call, await $request);
