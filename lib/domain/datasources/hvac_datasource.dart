...
abstract class IHvacDataSource {
  ...
  ///
  /// Отправляет команду устройству опубликовать все свои топики в MQTT.
  /// Используется при загрузке страницы для получения актуальных данных.
  Future<void> requestUpdate(String deviceId);
}
