...
class HvacTheme {
  ...
  // ============================================================================
  // LIGHT THEME - NEW Blue & White balanced design
  // ============================================================================

  /// Create light theme with HVAC styling (Blue & White balanced)
  static ThemeData lightTheme() {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        ...
        secondary: HvacColors.blue300,
        surface: HvacColors.backgroundCard,
        error: HvacColors.error,
        onPrimary: HvacColors.secondary,
        onSecondary: HvacColors.textPrimary,
        onSurface: HvacColors.textPrimary,
        onError: HvacColors.secondary,
      ),

      scaffoldBackgroundColor: HvacColors.backgroundSecondary,
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor: HvacColors.backgroundCard,
        selectedItemColor: HvacColors.primary,
        unselectedItemColor: HvacColors.textTertiary,
        type: BottomNavigationBarType.fixed,
        elevation: 0,
        showSelectedLabels: false,
        showUnselectedLabels: false,
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          foregroundColor: HvacColors.secondary,
          elevation: 0,
          padding: const EdgeInsets.symmetric(
            horizontal: HvacSpacing.lg,
            vertical: HvacSpacing.md,
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          foregroundColor: HvacColors.primary,
          padding: const EdgeInsets.symmetric(
            horizontal: HvacSpacing.md,
            vertical: HvacSpacing.sm,
          ),
      ...
      // Slider Theme
      sliderTheme: const SliderThemeData(
        activeTrackColor: HvacColors.primary,
        inactiveTrackColor: HvacColors.neutral200,
        thumbColor: HvacColors.primary,
        overlayColor: HvacColors.accentSubtle,
        trackHeight: 4,
      ),
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        checkColor: WidgetStateProperty.all(HvacColors.secondary),
        side: const BorderSide(
          color: HvacColors.neutral300,
          width: 2,
        ),
      ),
      ...
      // Chip Theme
      chipTheme: ChipThemeData(
        backgroundColor: HvacColors.blue50,
        selectedColor: HvacColors.primary,
        disabledColor: HvacColors.neutral200,
        padding: const EdgeInsets.symmetric(
          horizontal: HvacSpacing.sm,
          vertical: HvacSpacing.xs,
        ),
      ...
      progressIndicatorTheme: const ProgressIndicatorThemeData(
        color: HvacColors.primary,
        linearTrackColor: HvacColors.neutral200,
        circularTrackColor: HvacColors.neutral200,
      ),
    );
  }
